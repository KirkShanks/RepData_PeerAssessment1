...
## Mean steps per day
There were on average `r mean(DF2$steps)` steps per day.
```{r, echo=TRUE}
mean(DF2$steps)
```

## Median steps per day
The medain number of steps per day are `r median(DF2$steps)`.
```{r, echo=TRUE}
median(DF2$steps)
```
...
## Mean steps per day
There were on average `r mean(DF3$steps)` steps per day.
```{r, echo=TRUE}
mean(DF3$steps)
```

## Median steps per day
The medain number of steps per day are `r median(DF3$steps)`.
```{r, echo=TRUE}
median(DF3$steps)
```
